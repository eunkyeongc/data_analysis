...
작업일자 : 2026-08-03
작업자 : 홍은경
목적: train.py 로 만든 churn_model.joblib를 실제로 사용하는 사용자화면 코드(웹페이지 화면), 시각적.
데이터 파일 : machine_learning/streamlit_app.,py
